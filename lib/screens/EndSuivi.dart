...
import 'home.dart';
class EndSuivi extends StatefulWidget {
  EndSuivi({Key key, this.title, this.titre}) : super(key: key);
  String title = "Suivi du colis" ;
  final String titre;

  @override
  _EndSuiviState createState() => _EndSuiviState();
}

class _EndSuiviState extends State<EndSuivi> {
  ...
  void initState() {
    ...
    timer = Timer.periodic(Duration(seconds: 1), (Timer t) => checkMove());

  }

  void checkMove() async {
